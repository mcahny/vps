...
class CityscapesExt(BaseDataset):
    ...
    def evaluate_panoptic(self, pred_pans_2ch, output_dir, is_track=False, n_video=0, save_name=None):
        ...
        #         pdb.set_trace()
        #         dbg = self.pq_compute_single_core(proc_id, gt_jsons_set, pred_jsons_set, gt_pans_set, pred_pans_set, gt_image_jsons_set, categories, nframes)
        #         pdb.set_trace()
        #         dbg = CityscapesExt._pq_compute_single_core(proc_id, gt_jsons_set, pred_jsons_set, gt_pans_set, pred_pans_set, gt_image_jsons_set, categories, nframes)
        #         pdb.set_trace()
        #         p = workers.apply_async(CityscapesExt._pq_compute_single_core, (proc_id, gt_jsons_set, pred_jsons_set, gt_pans_set, pred_pans_set, gt_image_jsons_set, categories, nframes))
        #         processes.append(p)
        #     workers.close()
        #     workers.join()
        #     pq_stat = PQStat()
    ...
    # @staticmethod
    def pq_compute_single_core(proc_id, gt_jsons_set, pred_jsons_set, gt_pans_set, pred_pans_set, gt_image_jsons_set, categories):
        OFFSET = 256 * 256 * 256
        VOID = 0
        SIZE_THR = 32**2
        pq_stat = PQStat()
