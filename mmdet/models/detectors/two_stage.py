...
from .test_mixins import BBoxTestMixin, MaskTestMixin, RPNTestMixin, SemanticSegmTestMixin
import pdb
...
class TwoStageDetector(BaseDetector, RPNTestMixin, BBoxTestMixin,
    ...
    def __init__(self,
        ...
        if extra_neck is not None:
            self.extra_neck = builder.build_extra_neck(extra_neck)
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.with_extra_neck:
            self.extra_neck.init_weights()
        if self.with_track:
